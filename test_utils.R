...
detectAnomaly <- function(usual = createDays(10, 0.05), strange = NULL){
  ...
  res = AnomalyDetectionVec(all, max_anoms = 0.015, num_period_in_part = 3, sample_step = 1, anoms_threshold = 1.15, down_sample_step = 10, period = pointPerDay, direction='both', plot=TRUE)
  res$plot
}
...
tmp <- function(){
  ...
  res = AnomalyDetectionVec(blabla, max_anoms=0.001, num_period_in_part = 3, sample_step = 1, anoms_threshold = 1.15, down_sample_step = 10, alpha = 0.4, period=400, direction='both', plot=TRUE)
  res$plot
}
...
bumpInDoublePick <- function(){
  ...
  res = AnomalyDetectionVec(all, max_anoms=0.49, num_period_in_part = 3, sample_step = 1, anoms_threshold = 1.15, down_sample_step = 10, period = pointPerDay*2, direction='both', plot=TRUE)
  res$plot
}
...
exponentialGrow <- function(){
  ...
  plot(as.ts(allDays))
  res = AnomalyDetectionVec(allDays, max_anoms=0.49, num_period_in_part = 3, sample_step = 1, anoms_threshold = 1.15, down_sample_step = 10, period = pointPerDay, direction='both', plot=TRUE)
  res$plot
}
